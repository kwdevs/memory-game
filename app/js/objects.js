/* The purpos of this folder is to create all the objects we will need for our game. By seperating
...
let moveCounter = {
	...
	currentMoveCount: //this will keep the users current move count as the game progresses.
	resetMoveCount: //this method will reset the move count on new game or game reset.
};
...
let timer = {
	...
	currentTime: //tracks current time
	updateTimer: //method to update display of time
}
